...
description: "[](https://github.com/iammm0/execgo-runtime/actions/workflows/ci.yml)"
---
...
**Current version**: `1.1.0` (see [Versioning & tags](/docs/runtime/deployment)).
...
Defaults: listen on `0.0.0.0:8080`, data directory `/data`. See [Deployment](/docs/runtime/deployment).
...
Common server flags are documented in [CLI reference](/docs/runtime/cli) (concurrency limits, queue length, GC, grace periods, etc.).
...
Full JSON models and examples: [API reference](/docs/runtime/api).
...
| Doc | Contents |
|-----|----------|
| [docs/README.md](/docs/runtime/documentation-map) | Documentation index |
| [docs/architecture.md](/docs/runtime/architecture) | Architecture and execution flow |
| [docs/api.md](/docs/runtime/api) | HTTP API and JSON models |
| [docs/cli.md](/docs/runtime/cli) | CLI flags |
| [docs/deployment.md](/docs/runtime/deployment) | Deployment, Docker, CI/CD, tags |
| [docs/development.md](/docs/runtime/development) | Local development, testing, style |
...
3. Write commit messages that explain **motivation and behavior changes** (aligned with [development.md](/docs/runtime/development)).
...
**Repository**: [https://github.com/iammm0/execgo-runtime](https://github.com/iammm0/execgo-runtime)
