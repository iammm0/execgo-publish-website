...
- [Mode A (CLI)](/docs/execgo/integration/mode-a-cli) (English)
- [模式 A（CLI）](https://github.com/iammm0/execgo/blob/release/agent-adapter-runtime/docs/zh/integration/mode-a-cli.md) (中文)
- [execgocli contract](/docs/execgo/reference/execgo-cli-contract)
