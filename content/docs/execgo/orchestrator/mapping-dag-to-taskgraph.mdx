---
title: "Mapping：DAG -> TaskGraph"
description: "This page explains how an orchestration layer should map its own workflow nodes/edges into ExecGo's runtime-expected TaskGraph."
---
