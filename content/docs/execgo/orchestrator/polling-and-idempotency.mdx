---
title: "Polling & idempotency：stable submit & read results"
description: "ExecGo runs tasks asynchronously. After submitting a TaskGraph, you must poll task states and interpret final outcomes."
---
