---
title: "Promotion-period security defaults"
description: "During adoption of Mode A (/adapters/actions via execgocli or HTTP), apply the following defaults before opening agents to production data."
---
...
- [Shell executor / OS](/docs/execgo/reference/executors)
