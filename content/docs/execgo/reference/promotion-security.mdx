---
title: "推广期安全默认"
description: "在采用 模式 A（经 execgocli 或 HTTP 调 POST /adapters/actions）面向更大数据/生产之前，建议落实以下基线。"
---
...
- [执行器与内置能力](/docs/execgo/reference/executors)
- [ExecGo 与 execgo-runtime 关系](/docs/ecosystem/execgo-and-runtime)
- [execgocli 契约](/docs/execgo/reference/execgo-cli-contract)
