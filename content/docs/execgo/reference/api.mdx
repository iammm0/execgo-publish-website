...
description: "ExecGo exposes a small HTTP API for task submission and task lifecycle management:"
---
...
- [`API 参考`](https://github.com/iammm0/execgo/blob/release/agent-adapter-runtime/docs/zh/reference/API%20%E5%8F%82%E8%80%83/API%20%E5%8F%82%E8%80%83.md) (Chinese full text)
- [Mature agent adapter integration](/docs/execgo/integration/agent-adapter)
