---
title: "模式 A 快速开始：execgocli"
description: "模式 A：GET /adapters/tools 发现能力 → POST /adapters/actions 提交 action → GET /tasks/{id} 轮询。execgocli 在 stdout 输出统一 JSON 外壳，便于 agent 解析。"
---
...
- [execgocli JSON 契约](/docs/execgo/reference/execgo-cli-contract)
