---
title: "Mode A quick start: `execgocli`"
description: "Mode A = discover tools via GET /adapters/tools, submit actions via POST /adapters/actions, poll GET /tasks/{id}. The execgocli command wraps the same flow with"
---
...
- [execgocli JSON contract](/docs/execgo/reference/execgo-cli-contract)

## Related

- [Mature agent adapter](/docs/execgo/integration/agent-adapter)
- [Mode B upgrade](/docs/execgo/integration/mode-b-upgrade)
