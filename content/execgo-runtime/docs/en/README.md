...
**Data-plane runtime** for the ExecGo ecosystem: a Rust service for async task submit, schedule, execute, and persist, exposed via **HTTP API** and **CLI**. It acts as the execution backend behind the ExecGo control plane.
